...
/**
 * Created by alumne on 18/05/16.
 */
public class ArrayAdapterLibros2 extends BaseAdapter {
    ArrayList<Libros> myList = new ArrayList<>();
    LayoutInflater inflater;
    Context context;
    public ArrayAdapterLibros2(Context context, ArrayList<Libros> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_view_layoutdos, parent, false);
        ...
        mViewHolder.tvCoduser.setText(currentListData.getCoduser());
        return convertView;
    }

    private class MyViewHolder {
        TextView tvName, tvEditorial,tvGenero,tvPrecio,tvCoduser;
        ImageView ivImage;
        ...
        public MyViewHolder(View item) {
            ...
            tvCoduser = (TextView)item.findViewById(R.id.textViewCoduser);
        }
    }
}
